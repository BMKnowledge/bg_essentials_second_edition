...
\includegraphics[width=0.9\textwidth]{assets/imgs/Guruji_epub.jpg} 
...
Rooted in traditional \textit{bhakti-yoga}, the path of loving devotion, Paramahamsa Vishwananda’s mission is to open the hearts of mankind to the love of God in our modern times.  He reminds us that spirituality is not just a complementary part of our lives; rather it is their very foundation---to be lived and expressed in every moment. All genuine spiritual practices, rituals, and knowledge lead us beyond the confines of ego and mind, awakening a living, breathing relationship with an infinite, blissful, and loving God.
...
\item Simply letting the \textit{Bhagavad Gītā} fall open to any page allows the Divine to reveal something to you in the moment. Take it as a gift and contemplate on what you find. 

\end{itemize}

Whether you read a verse a day, a chapter a week, the verses alone, only the commentary, or you just open the \textit{Bhagavad Gītā} to see what will be revealed to you in the moment, you’ll surely want to keep it close at hand and make it a part of your daily life.
...
The \textit{Bhagavad Gītā} is part of a much larger scripture known as the \textit{Mahābhārata} which details the history of the kings in the ancient Kuru dynasty. 

It all takes place about 5,000 years ago in India. Pāṇḍu ruled the kingdom of Hastināpura, but due to a curse, he retired to the forest with his wives, leaving his blind brother, Dhṛtarāṣṭra, to take the throne. Eventually children were born. The five sons of Pāṇḍu (Yudhiṣṭhira, Bhīma, Arjuna, Nakula, and Sahadeva) were known as the Pāṇḍavas, while the hundred sons of Dhṛtarāṣṭra were called the Kauravas. 
...
At this point, both sides gathered up their allies in preparation. Despite their affection for the Pāṇḍavas, many elders and relatives, such as their grandfather Bhīṣma and their teacher Droṇa, join the Kaurava army. All are profoundly aware of Duryodhana’s arrogance and unrighteous behavior, but filled with a sense of duty to the kingdom, they are ready to fight for him. Consequently, one family stands divided on the Kurukṣetra battlefield. 
...
\chapter{Chapter 1: \\Arjuna-viṣāda-yoga}\label{chap-arjuna-visada-yoga}

\paragraph*{\MakeUppercase{The Lamentation of Arjuna}}
...
\enquote{Both families were from the Kuru dynasty. But the king refused to recognize the Pāṇḍavas. The mind doesn’t recognize the good qualities which are present in oneself. The mind can only look toward the senses, looking always toward the outside. The Self, and the positive qualities which are present inside, are not comprehended by it.}
...
\noindent There are Dhṛṣṭaketu, Cekitāna, and the valiant king of Kāśī, Purujit, Kuntibhoja, and Śaibya, the best among men. (1.5)
\end{verse}
\par
...
\noindent This force of our army marshaled by Bhīṣma is immeasurable, while the strength of their army guarded by Bhīma is limited. (1.10)
\end{verse}
\par
...
\enquote{Droṇācārya represents attachment to the material. He represents the greed in man. Droṇācārya also had good qualities. He was a great teacher of military science. Sometimes he would even advise Bhīṣma. He was the royal \textit{guru}. But when the pride of Duryodhana saw the greed in Droṇācārya, he said to himself, \enquote{Let me go and feed his greed. Let me corrupt him.}}
...
\enquote{In this battlefield of life, if you create an illusion to make yourself feel happy, then if anything appears in front of you, you try to find ways to run away from it. This is cowardice, going sideways, \enquote{putting it in a drawer.} You will never be free, because sooner or later you will be facing the same thing again. But once you have faced it, it will never come back to you again.}
 \chapter{Chapter 2: \\Sāṅkhya-yoga}\label{chap-sankhya-yoga}

\paragraph*{\MakeUppercase{The Eternal Nature of the Self}}
...
Having established Arjuna in this philosophical understanding, Kṛṣṇa proceeds to teach one of the fundamental concepts of the \textit{Gītā}: \textit{karma-yoga}. He explains that those of small intelligence perform various duties with the hope of gaining some limited reward; this attachment to results is what produces \textit{karma}.\footnote{Any action done with the body or mind that produces further consequences.} But Kṛṣṇa urges Arjuna to carry out his duty as a warrior without any attachment to the results. By engaging in righteous action without any selfish gain, one can be freed from all \textit{karmic} consequences. With the senses restrained and the mind controlled, one is not distracted by the ways of the world. In this desireless state, a \textit{yogī} achieves perfect wisdom and peace.
...
} provides the centerpiece for Kṛṣṇa's teachings over the next four chapters. We learn about the real meaning of action, what true renunciation is, and the ultimate state that is reached when practicing this \textit{yoga}.
...
\noindent It cannot be cut; it cannot be burned; it cannot be wetted, and it cannot be dried. It is eternal, all-pervading, changeless, immovable, and everlasting. (2.24)
\end{verse}
\par
...
\enquote{Kṛṣṇa is saying that everybody knows that they are not the body, everybody knows that they are not the mind, they are not the intellect, but yet, they still identify themselves with them. This is due to the lack of true knowledge, lack of true understanding. You have received this knowledge through books; reading wonderful books has given you this insight. You have heard many talks about it, but it has just remained as words which are pleasurable to you. It doesn’t have any effect upon you. You are still running after the external pleasures; you are still running after things that are perishable.}
...
\par
\begin{verse}
\textit{eṣā te ’bhihitā sāṅkhye buddhir yoge tv imāṁ śṛṇu} \\
\textit{buddhyā yukto yayā pārtha karma-bandhaṁ prahāsyasi}

\noindent The knowledge which I have taught to you so far is based on Sāṅkhya.\footnote{A philosophy which states that there are two realities: the \textit{puruṣa} (Self) and \textit{prakṛti} (matter). Through an analysis of \textit{prakṛti}, one can realize oneself as the \textit{puruṣa}, which is utterly distinct from material nature.} Now listen to the teaching concerning \textit{karma-yoga}. O Pārtha, by being endowed with this wisdom, you will escape the bondage of \textit{karma}. (2.39)
\end{verse}
\par
...
\par
\begin{verse}
\textit{trai-guṇya-viṣayā vedā nistrai-guṇyo bhavārjuna} \\
\textit{nirdvandvo nitya-sattva-stho niryoga-kṣema ātmavān}

\noindent The \textit{Vedas}\footnote{The earliest body of Indian scripture, consisting of the \textit{Ṛg Veda}, \textit{Sāma Veda}, \textit{Yajur Veda}, and \textit{Atharva Veda}, which lay down the fundamental principles of Hinduism.} deal with the three \textit{guṇas},\footnote{The three qualities within \textit{prakṛti} (matter): \textit{sattva} (purity), \textit{rajas} (activity), and \textit{tamas} (darkness). The different \textit{guṇas} work together to shape and influence the experience we have in the material world.} O Arjuna. You must become free from these \textit{guṇas} and the pairs of opposites. Be ever established in \textit{sattva-guṇa},\footnote{Quality of gentility, good conduct, enlightened understanding, purity, and detachment.} free from concerns of gain and protection---instead, be established in the \textit{ātmā}. (2.45)
\end{verse}
\par
...
\noindent You have only the right to act, but never to the fruits of action. Do not consider yourself the cause of the outcomes of action, nor let there be any attachment to avoiding action. (2.47)
\end{verse}
\par
...
\noindent \quad Bhagavān Kṛṣṇa said:\linebreak When one gives up all desires arising in the mind, O Pārtha, and is satisfied within oneself by the Self alone, then one is said to be of steady wisdom. (2.55)
\end{verse}
\par
...
\par
\begin{verse}
\textit{āpūryamāṇam acala-pratiṣṭhaṁ} \\
\textit{samudram āpaḥ praviśanti yadvat} \\
\textit{tadvat kāmā yaṁ praviśanti sarve} \\
\textit{sa śāntim āpnoti na kāma-kāmī}
...
\enquote{So, long for the grace of the Lord, long for Him; don’t let yourself be put under the spell of \textit{māyā}.\footnote{The influence of the material world that draws us away from our true relationship with God.} Because \textit{māyā} doesn’t have any grip upon those who are centered in the Lord\ldots they are free. They go everywhere. They radiate their peace, freedom, and true happiness freely to all, without expectation. They become a lantern to those seated in darkness. They become a guide to those who sit in darkness so that they can also start shining their light. This is the duty of a devotee, the duty of a \textit{bhakta}:\footnote{One who is devoted to God.} once they have tasted that sweetness of the Love of God, and once they are strong enough, they should help others find that light.}
 \chapter{Chapter 3: \\Karma-yoga}\label{chap-karma-yoga}
...
\par
\begin{verse}
\textit{devān bhāvayatānena te devā bhāvayantu vaḥ} \\
\textit{parasparaṁ bhāvayantaḥ śreyaḥ param avāpsyatha}

\noindent \enquote{By this, may you nurture the \textit{devas}, and may the \textit{devas} in return nurture you. In this way, nurturing one another, you will obtain the highest welfare.} (3.11)
\end{verse}
\par
...
\noindent But for the person who delights in the \textit{ātmā} alone, who is satisfied with the \textit{ātmā} and rejoices only in the \textit{ātmā}, duties do not exist. (3.17)
\end{verse}
\par
...
\par
\begin{verse}
\textit{karmaṇaiva hi saṁsiddhim āsthitā janakādayaḥ} \\
\textit{loka-saṅgraham evāpi sampaśyan kartum arhasi}

\noindent Verily, by selfless action alone did Janaka\footnote{A great king who achieved realization through the practice of \textit{karma-yoga}. An ideal example of one who acts in the world but is detached from his actions.} and others reach perfection. Indeed, also considering the welfare of the world, you should act. (3.20)
\end{verse}
\par
...
\noindent O Bharata, just as the ignorant act with attachment to their work, so should the wise act without any attachment, being intent on the welfare of the world. (3.25)
\end{verse}
\par
...
\enquote{Here Bhagavān Himself is reminding: \enquote{Look at Me, dear Arjuna. I am free from these three worlds. Māyā doesn’t have any power over Me. Illusion is far away. I am free from that and I don’t need anything, because I have created everything. Everything comes from Me. I am in everything. But I’m doing My duty, not running away from My duty. I have taken this form for a purpose.}}
...
\begin{verse}
\textit{śrī-bhagavān uvāca} \\
\textit{kāma eṣa krodha eṣa rajo-guṇa-samudbhavaḥ} \\
\textit{mahāśano mahā-pāpmā viddhy enam iha vairiṇam}

\noindent \quad Bhagavān Kṛṣṇa said:\linebreak It is desire born of \textit{rajo-guṇa}\footnote{The \textit{guṇa} relating to the quality of passion and activity.} and its resulting anger. Know it to be the all-devouring, exceedingly wicked enemy in this world. (3.37)
\end{verse}
\par
...
\enquote{In \textit{karma-yoga}, if you do everything in this world with an attitude of surrender, you will attain Him. Kṛṣṇa says to Arjuna, \enquote{Without controlling the senses, it will not be possible. If you give in, you will bring about your own damnation. But with control, you will free yourself. It is in your hands!} God will help you when you start helping yourself. Once you take your first step, He will give you courage; He will give you support; He will bring you to where you have to be.}
 ...
 \chapter{Chapter 4: \\Jñāna-vibhāga-yoga}\label{chap-jnana-vibhaga-yoga}

\paragraph*{\MakeUppercase{The Path of Knowledge}}
...
\par
\begin{verse}
\textit{cātur-varṇyaṁ mayā sṛṣṭaṁ guṇa-karma-vibhāgaśaḥ} \\
\textit{tasya kartāram api māṁ viddhy akartāram avyayam}

\noindent The system of the four \textit{varṇas}\footnote{The different social classes within \textit{Vedic} culture, namely the \textit{brāhmaṇas} (sages and priests), \textit{kṣatriyas} (warriors and royal leaders), \textit{vaiśyas} (merchants responsible for commerce), and \textit{śūdras} (responsible for general labor). In order to ensure a prosperous society, these different groups were allocated different responsibilities for the welfare of everyone at large.} was created by Me, based on the division of predominant qualities and corresponding actions. Despite being their creator, know Me to be a non-doer and changeless. (4.13)
\end{verse}
\par
...
\enquote{True happiness can be given only by the Lord Himself. Only when you long for Him, He reciprocates the feeling that you have inside of you, not just one time, but one hundred times more\ldots You think that you are thinking of Him. No. He is thinking of you. You think that you are going to Him; He is running toward you. You think of Him, you long for Him, but in His heart, He is pining for you.}
...
\noindent One whose every action is free from the egoistic desire to enjoy and whose actions are burned up by the fire of knowledge, is declared a sage by the wise. (4.19)
\end{verse}
\par
...
\enquote{Nowadays, there are many schools of \textit{yoga}; each one claims that their \textit{yoga} is better than the others. But when one is realized, one sees that all ways are right, because God puts people where they have to be. So if there is true realization, there is no judgment. If one has divine knowledge, one should not have any judgment toward anyone; one should not have any enmity or aggressiveness toward anyone.}
...
\noindent Still there are others devoted to \textit{prāṇāyāma}, who while regulating the movement of \textit{prāṇa} and \textit{apāna}, offer \textit{prāṇa} into \textit{apāna}, and likewise \textit{apāna} into \textit{prāṇa}. (4.29)
\end{verse}
\par
...
\enquote{By surrendering to the feet of the master, all the errors of lives are removed. Once you have this right knowledge about the \textit{ātmā}, the Truth will be revealed. That supremacy of the Lord will be revealed, not outside, but first inside of yourself.}
 \chapter{Chapter 5: \\Karma-sannyāsa-yoga}\label{chap-karma-sannyasa-yoga}
...
\section{Verses 1-7: Jñāna-yoga and Karma-yoga Are Ultimately the Same}
...
\textit{ekaṁ sāṅkhyaṁ ca yogam ca yaḥ paśyati sa paśyati}
...
\enquote{Renouncing everything for something will not bring you peace, because there will always be an expectation. And when this expectation is not fulfilled, what will arise? Frustration. And frustration will lead you to anger. Anger will lead you to mental stress.}
...
\noindent The Lord neither creates the sense of agency, nor initiates people’s actions, nor creates the connection between actions and their results---the \textit{jīva's} external nature accomplishes all this. (5.14)
\end{verse}
\par
...
\noindent Now that renunciation and the nature of action have been thoroughly explained, chapter six begins to describe \textit{dhyāna-yoga} or meditation. Kṛṣṇa has thus far provided a step-by-step path beginning with \textit{karma-yoga}. Once this is successfully practiced, one achieves inner tranquility. This creates the desired state for \textit{dhyāna-yoga}, where the mind is made to focus within and have the direct perception of the \textit{ātmā}.
...
\noindent O Pāṇḍava, know what is called renunciation to be \textit{yoga}. For no one becomes a \textit{karma-yogī} without renouncing desire. (6.2)
\end{verse}
\par
...
\par
\begin{verse}
\textit{śucau deśe pratiṣṭhāpya sthiram āsanam ātmanaḥ} \\
\textit{nāty-ucchritaṁ nāti-nīcaṁ cailājina-kuśottaram}

\noindent In a pure place, one should establish a firm seat for oneself which is neither too high nor too low, with a cloth and deer-skin on top of \textit{kuśa} grass.\footnote{A type of grass considered sacred in India. It is generally used for purification or as a conduit for energy during \textit{pūjā} and ritual ceremonies. It can also be used to construct a seat for meditation.} (6.11)
\end{verse}
\par
...
\enquote{The time and the place of meditation are very important, because when you set a certain time to meditate, you are inviting God to be there with you. It’s like if you invite a friend to come to your place and then you are not there to welcome your friend. How would it be? Or you are invited somewhere, you are ringing the bell and you see all the lights off. Then someone turns the light on and you see the person in pajamas saying, \enquote{Ai! I thought it was tomorrow!} How would it be? You would be shocked, no? So, here it is the same thing. When you set a certain time to sit for meditation, you are inviting God to manifest Himself at that moment. And you can have this expectation that, as you sent the invitation, God will come and be eagerly waiting for you inside yourself at that time.}
...
\noindent Just as the light of a lamp in a windless place does not flicker, so it is with the \textit{yogī} who has a controlled mind and relentlessly practices union with the \textit{ātmā}. This is the analogy that is cited in this regard. (6.19)
\end{verse}
\par
...
\noindent O Arjuna, one who sees everything equally, whether happiness or suffering, by comparison to the nature of their own \textit{ātmā}, is considered to be the highest \textit{yogī}. (6.32)
\end{verse}
\par
...
\noindent But the \textit{yogī} who strives diligently and is cleansed from impurities, attains perfection after many lifetimes and thereafter reaches the supreme goal. (6.45)
\end{verse}
\par
...
\enquote{The soul sees the path that will lead one to the spiritual family---\textit{vasudhaiva-kuṭumbakaṁ}---this unification of one family\ldots A real family is one that shares with you, who stands with you, however you are, who supports you on your way. That’s real family.}
 \chapter{Chapter 7: \\Jñāna-vijñāna-yoga}\label{chap-jnana-vijnana-yoga}

\paragraph*{\MakeUppercase{Knowledge of Kṛṣṇa}}
...
In this chapter, Arjuna learns how this world and the individual souls rest upon Kṛṣṇa, forming a part of His cosmic form. Not only does Kṛṣṇa support creation, but He is actually immanent within each and every aspect of it. He is the fragrance of the earth, the brilliance of fire, and the life of all life.
...
\noindent \quad Bhagavān Kṛṣṇa said:\linebreak Listen, Pārtha, to how with your mind attached to Me, practicing \textit{yoga}, and taking shelter in Me, you will without doubt know Me completely. (7.1)
\end{verse}
\par
...
\section{Verses 4-6: The Higher and Lower Natures of God}\label{sec-verses-4-11-the-higher-and-lower-natures-of-god}
...
\noindent Moreover, I am the strength of the strong, free from desire and passion. I am that desire in living beings which is compatible with \textit{dharma}, O best of the Bharatas. (7.11)
\end{verse}
\par
...
\enquote{[The Lord is saying:] \enquote{As I am not touched by \textit{māyā}, so My devotees who are surrendered to Me are free. Māyā stops controlling them. Those who chant My Name; those who by any means try to control their mind; those who are fully absorbed in My service, forgetting themselves completely; those who think only on Me; they are My devotees, and they cross beyond the \textit{guṇas}. The \textit{guṇas} don’t have any effect on them, because they become as Me. I start to shine upon them and they start to reflect My divine qualities, My cosmic qualities, and wherever My cosmic qualities are shining, \textit{māyā} doesn’t have any power.} Here Bhagavān is saying, \enquote{Even if it appears as if Māyā controls everything, I am the Lord of Māyā and I control Her.}}
...
\noindent Four kinds of virtuous people worship Me, O Arjuna: the distressed, the seeker of knowledge, the one who desires wealth, and the wise \textit{jñānī},\footnote{The pure devotee who possesses knowledge of who the Lord truly is.} O best of Bharatas. (7.16)
\end{verse}
\par
...
\enquote{This indestructible Self, which is above all the material nature, is the higher nature itself. It is this divinity, Parabrahman, Kṛṣṇa Himself, who is the source and the core of the individual soul.}
...
\par
\begin{verse}
\textit{kaviṁ purāṇam anuśāsitāram} \\
\textit{aṇor aṇīyāṁsam anusmared yaḥ} \\
\textit{sarvasya dhātāram acintya-rūpam} \\
\textit{āditya-varṇaṁ tamasaḥ parastāt} \\
\textit{prayāṇa-kāle manasācalena} \\
\textit{bhaktyā yukto yoga-balena caiva} \\
\textit{bhruvor madhye prāṇam āveśya samyak} \\
\textit{sa taṁ paraṁ puruṣam upaiti divyam}
...
\par
\begin{verse}
\textit{yad akṣaraṁ veda-vido vadanti} \\
\textit{viśanti yad yatayo vīta-rāgāḥ} \\
\textit{yad icchanto brahmacaryaṁ caranti} \\
\textit{tat te padaṁ saṅgraheṇa pravakṣye}
...
\par
\begin{verse}
\textit{sahasra-yuga-paryantam ahar yad brahmaṇo viduḥ} \\
\textit{rātriṁ yuga-sahasrāntāṁ te ’ho-rātra-vido janāḥ}

\noindent Those who understand that a Day of Brahmā lasts for a thousand \textit{mahā-yugas}\footnote{Defined as an age or epoch in Hindu cosmology. There are four distinct yugas: \textit{Satya-yuga}, \textit{Tretā-yuga}, \textit{Dvāpara-yuga}, and \textit{Kali-yuga}, each period being shorter, darker, and less righteous than the preceding. Mankind is currently in the age of \textit{Kali-yuga}. In this verse, Kṛṣṇa states that both a Day and a Night of Brahmā last a \enquote{thousand \textit{mahā-yugas}} which is actually a thousand cycles of the four \textit{yugas} mentioned, a period that lasts trillions of years.} and a Night of Brahmā lasts for another thousand \textit{mahā-yugas}, are the knowers of a cosmic Day and Night. (8.17)
\end{verse}
\par
...
\par
\begin{verse}
\textit{vedeṣu yajñeṣu tapaḥsu caiva} \\
\textit{dāneṣu yat puṇya-phalaṁ pradiṣṭam} \\
\textit{atyeti tat sarvam idaṁ viditvā} \\
\textit{yogī paraṁ sthānam upaiti cādyam}
...
\enquote{Death doesn’t have any effect on the ones who are completely surrendered to Him [Kṛṣṇa]. Not even Yamarāja, the lord of death, has power over the \textit{bhaktas} of the Lord. They leave this world when He wills them to leave and they come back again when He wills them to come back. A \textit{yogī}, a \textit{bhakta} is fully absorbed into God consciousness, so he will not stay here forever.}
...
\enquote{The \textit{bhaktas} who are surrendered, who have not fully realized themselves before departing this world, go to higher \textit{lokas} to perfect themselves and then they come back again. And when they come back again, they come for the benefit of others. Kṛṣṇa says, \enquote{Because they are fully surrendered, I Myself send them down.} The saints, who are born again on Earth for the welfare of society, come to remind others about the goal of life.}
 \chapter{Chapter 9: \\Rāja-vidyā-guhya-yoga}\label{chap-raja-vidya-guhya-yoga}

\paragraph*{\MakeUppercase{The Secret of Devotion}}
...
\noindent Under My direction this \textit{prakṛti} brings forth all the moving and unmoving beings. By this reason alone the world operates as it does, O Kaunteya. (9.10)
\end{verse}
\par
...
\enquote{At the end of the dissolution period, another creation manifests. The whole world dissolves into Him and, afterward, a new world arises from Him. The dissolution period also enables the \textit{ātmā}, the individual soul, to move to a higher level of realization.}
...
\par
\begin{verse}
\textit{trai-vidyā māṁ soma-pāḥ pūta-pāpā} \\
\textit{yajñair iṣṭvā svar-gatiṁ prārthayante} \\
\textit{te puṇyam āsādya surendra-lokam} \\
\textit{aśnanti divyān divi deva-bhogān}

\noindent Those who follow the three \textit{Vedas}, purified from sin by drinking the \textit{soma} juice,\footnote{A powerful plant extract that formed a central part of the \textit{Vedic} ritual sacrifice.} pray to attain Heaven\footnote{In the context of this verse, Heaven is not the Supreme Abode of the Lord, but is considered to be the material realm of the demigods where one can temporarily enjoy celestial pleasures.} and worship Me with sacrifices. After reaching the realm of Indra,\footnote{The leader of the \textit{devas} and the ruler of the heavens.} they enjoy celestial pleasures of the \textit{devas} in Heaven. (9.20)
\end{verse}
\par
...
\noindent But for those who are single-mindedly focused on Me and worship Me, for them who are absorbed in Me and ever in union with Me, I personally take responsibility for their prosperity and welfare. (9.22)
\end{verse}
\par
...
\enquote{Here He says to Arjuna, \enquote{Focus your mind on Me, be devoted to Me, offer worship to Me.} Can you see the power that is behind this? Kṛṣṇa is not saying this superficially. No! Here is God Himself talking to Arjuna with all power! There is no pride in it. He says, \enquote{Here I am, the Supreme Lord Himself. I’m God Himself. I’m the God of which speak the \textit{Vedas}. It is I who am here talking to you and I am telling you how to surrender to Me! Focus your mind on Me. Be devoted to Me. Awake. Let your heart dwell on Me. Offer worship to Me. Serve Me in your worship, in your charity, in your daily chores. Do it as a form of worship. Bow down to Me. Be humble. Engaging your mind in this manner and regarding Me as the supreme goal, you will come to Me.} If the mind and the heart are focused on the Lord, and everything one does is done with this attitude of surrender to the Lord, there is no doubt that one will reach Him.}
...
\par
\begin{verse}
\textit{maharṣayaḥ sapta pūrve catvāro manavas tathā} \\
\textit{mad-bhāvā mānasā jātā yeṣāṁ loka imāḥ prajāḥ}

\noindent The seven great seers\footnote{Created by Brahmā and known as the \textit{saptarṣis}, they are responsible for guiding the human race during the four \textit{yugas} (ages). They are in complete communion with the Lord at all times and work toward maintaining a balance on Earth. Before them, and also born from Brahmā, were the four Kumāras: Sanaka, Sanātana, Sanandana, Sanat-kumāra.} and before them the four Kumāras and the Manus\footnote{A title given to the first man of every age (known as a \textit{manvantara}). All humans are believed to have descended from his lineage. }---all are manifestations of My being, born from My mind. From them, all beings in the world descend. (10.6)
\end{verse}
\par
...
\noindent To those who are in constant union with Me and worship Me with intense affection, I grant the \textit{yoga} of understanding by which they attain Me. (10.10)
\end{verse}
\par
...
\noindent Thus, only You are capable of recounting in full Your divine glories. Please describe the manifestations by which You pervade and abide within all these worlds. (10.16)
\end{verse}
\par
...
\par
\begin{verse}
\textit{vedānāṁ sāma-vedo ’smi devānām asmi vāsavaḥ} \\
\textit{indriyāṇāṁ manaś cāsmi bhūtānām asmi cetanā}

\noindent Among the \textit{Vedas}, I am the \textit{Sāma Veda};\footnote{One of the four \textit{Vedas}. The \textit{Sāma Veda} contains melodies and chants.} among the \textit{devas}, I am Indra. Among the senses, I am the mind, and among living beings, I am consciousness. (10.22)
\end{verse}
\par
...
\par
\begin{verse}
\textit{purodhasāṁ ca mukhyaṁ māṁ viddhi pārtha bṛhaspatim} \\
\textit{senānīnām ahaṁ skandaḥ sarasām asmi sāgaraḥ}

\noindent O Pārtha, among the priests, know Me to be the chief: Bṛhaspati.\footnote{Deity responsible for wisdom and is the preceptor of the \textit{devas}.} Among army generals, I am Skanda.\footnote{Born from the third eye of Śiva, he is the brother of Gaṇeśa, and leads the celestial armies against the Asuras.} Among reservoirs of water, I am the ocean. (10.24)
\end{verse}
\par
...
\par
\begin{verse}
\textit{maharṣīṇāṁ bhṛgur ahaṁ girām asmy ekam akṣaram} \\
\textit{yajñānāṁ japa-yajño ’smi sthāvarāṇāṁ himālayaḥ}

\noindent Among the great sages, I am Bhṛgu.\footnote{One of the seven great \textit{saptarṣis} born from Brahmā.} Among words, I am the single syllable \enquote{\textit{oṁ}.} Among sacrifices, I am the sacrifice of \textit{japa}.\footnote{Meditative repetition of a \textit{mantra} or a Divine Name.} Among immovable things, I am the Himālayas. (10.25)
\end{verse}
\par
...
\par
\begin{verse}
\textit{aśvatthaḥ sarva-vṛkṣāṇāṁ devarṣīṇāṁ ca nāradaḥ} \\
\textit{gandharvāṇāṁ citrarathaḥ siddhānāṁ kapilo muniḥ}

\noindent Among all trees, I am the Aśvattha.\footnote{A sacred fig tree mentioned in various Hindu texts.} Among celestial seers, I am Nārada.\footnote{A great \textit{Vedic} sage born from Brahmā and one of the foremost devotees of the Lord. He wanders the universe imparting the knowledge of devotion.} Among the Gandharvas,\footnote{A group of celestial deities skilled in various arts such as music and dancing. Among the Gandharvas, Citraratha is said to be highly skilled in the art of singing.} I am Citraratha, and among perfected beings, I am the sage Kapila.\footnote{Incarnation of the Lord and a great sage who taught his mother Devahūtī the knowledge of the Self, as mentioned in the \textit{Śrīmad Bhāgavatam}.} (10.26)
\end{verse}
\par
...
\par
\begin{verse}
\textit{uccaiḥśravasam aśvānāṁ viddhi mām amṛtodbhavam} \\
\textit{airāvataṁ gajendrāṇāṁ narāṇāṁ ca narādhipam}

\noindent Among horses, know Me to be Uccaiḥśravas,\footnote{A beautiful white horse produced from the Ocean of Milk and claimed by Bali, the leader of the Asuras.} born from the churning of the milky ocean.\footnote{One of the central events in the eternal struggle between the \textit{devas} and \textit{asuras}. Both groups churned the Ocean of Milk to obtain the nectar of immortality (\textit{amṛta}).} Among mighty elephants, I am Airāvata,\footnote{Considered to be the best among elephants, and the vehicle of the king of the demigods (Indra).} and among humans, I am the king. (10.27)
\end{verse}
\par
...
\par
\begin{verse}
\textit{bṛhat-sāma tathā sāmnāṁ gāyatrī chandasām aham} \\
\textit{māsānāṁ mārga-śīrṣo ’ham ṛtūnāṁ kusumākaraḥ}

\noindent Among the hymns of the \textit{Sāma Veda}, I am the \textit{Bṛhat-sāma},\footnote{A hymn which praises the Lord. The \textit{Bṛhat-sāma} is chanted at the conclusion of auspicious \textit{Vedic} ceremonies.} and among \textit{Vedic} meters, I am the Gāyatrī.\footnote{Highly revered \textit{mantra} from the \textit{Ṛg Veda} dedicated to the Sun deity and is chanted widely by Hindus.} Among months, I am Mārgaśīrṣa,\footnote{The ninth month in the Hindu lunar calendar when grains from agriculture fields are collected by farmers to earn money and make their living in India.} and among seasons, I am spring. (10.35)
\end{verse}
\par
...
\par
\begin{verse}
\textit{vṛṣṇīnāṁ vāsudevo ’smi pāṇḍavānāṁ dhanañ-jayaḥ} \\
\textit{munīnām apy ahaṁ vyāsaḥ kavīnām uśanā kaviḥ}

\noindent Among the Vṛṣṇis,\footnote{Ancient \textit{Vedic} clan which Kṛṣṇa was born into. Vāsudeva, who belonged to the Vṛṣṇi clan, was the father of Kṛṣṇa.} I am Vāsudeva. Among the Pāṇḍavas, I am Arjuna. Among sages, I am Vyāsa,\footnote{A great \textit{Vedic} sage who organized and divided the \textit{Vedas}. He authored many of the \textit{puranic} scriptures, but is perhaps most famous for authoring the \textit{Mahābhārata} and the \textit{Śrīmad Bhāgavatam}.} and among great thinkers, I am Śukrācārya. (10.37)
\end{verse}
\par
...
\enquote{The Lord is not just a normal ordinary person, even if He appears very human. By being among the people on the battlefield in the Kurukṣetra, everybody could see Kṛṣṇa as normal, but in reality, He was God Himself. It is through Him that creation happens. It is through Him that creation is preserved, and it is through Him that dissolution happens.}
...
\enquote{The realized soul, the one who has ascended toward God consciousness, who has attained God-realization, perceives the eternal Supreme Lord with full knowledge and full awareness.}
...
\enquote{So, all these manifestations are sustained by just a fraction of Himself alone, it’s not His fullness. But, in that fraction resides the fullness. However, the fullness doesn’t reside in that fraction.}
 \chapter{Chapter 11: \\Viśvarūpa-darśana-yoga}\label{chap-visvarupa-darsana-yoga}

\paragraph*{\MakeUppercase{The Cosmic Form}}


\noindent Up until now, Kṛṣṇa has only described His identity as the Supreme Lord. But this description has awakened Arjuna’s longing to experience this divinity firsthand. As a result, Arjuna requests Kṛṣṇa to actually show him that which he has heard so much about. But this cosmic form (Viśvarūpa) is beyond the material world. As an act of grace therefore, Kṛṣṇa gifts Arjuna divine vision through which he can behold this inconceivable form.
...
\noindent O Guḍākeśa, witness the whole universe with moving and unmoving, and whatever else you wish to see, all here in one place within My body. (11.7)
\end{verse}
\par
...
\begin{verse}
\textit{arjuna uvāca} \\
\textit{paśyāmi devāṁs tava deva dehe} \\
\textit{sarvāṁs tathā bhūta-viśeṣa-saṅghān} \\
\textit{brahmāṇam īśaṁ kamalāsana-stham} \\
\textit{ṛṣīṁś ca sarvān uragāṁś ca divyān}
...
\par
\begin{verse}
\textit{aneka-bāhūdara-vaktra-netraṁ} \\
\textit{paśyāmi tvāṁ sarvato ’nanta-rūpam} \\
\textit{nāntaṁ na madhyaṁ na punas tavādiṁ} \\
\textit{paśyāmi viśveśvara viśva-rūpa}
...
\par
\begin{verse}
\textit{kirīṭinaṁ gadinaṁ cakriṇaṁ ca} \\
\textit{tejo-rāśiṁ sarvato dīptimantam} \\
\textit{paśyāmi tvāṁ durnirīkṣyaṁ samantād} \\
\textit{dīptānalārka-dyutim aprameyam}
...
\par
\begin{verse}
\textit{anādi-madhyāntam ananta-vīryam} \\
\textit{ananta-bāhuṁ śaśi-sūrya-netram} \\
\textit{paśyāmi tvāṁ dīpta-hutāśa-vaktraṁ} \\
\textit{sva-tejasā viśvam idaṁ tapantam}
...
\par
\begin{verse}
\textit{dyāv ā-pṛthivyor idam antaraṁ hi} \\
\textit{vyāptaṁ tvayaikena diśaś ca sarvāḥ} \\
\textit{dṛṣṭvādbhutaṁ rūpam ugraṁ tavedaṁ} \\
\textit{loka-trayaṁ pravyathitaṁ mahātman}

\noindent The space between Heaven and Earth, and all the directions, are pervaded by You alone. Beholding Your astounding and terrible form, O Great Soul, the three worlds\footnote{Referenced in \textit{Vedic} texts as Heaven, Earth, and the netherworld.} are trembling. (11.20)
\end{verse}
\par
...
\par
\begin{verse}
\textit{rudrādityā vasavo ye ca sādhyā} \\
\textit{viśve ’śvinau marutaś coṣmapāś ca} \\
\textit{gandharva-yakṣāsura-siddha-saṅghā} \\
\textit{vīkṣante tvāṁ vismitāś caiva sarve}
...
\par
\begin{verse}
\textit{rūpaṁ mahat te bahu-vaktra-netraṁ} \\
\textit{mahā-bāho bahu-bāhūru-pādam} \\
\textit{bahūdaraṁ bahu-daṁṣṭrā-karālaṁ} \\
\textit{dṛṣṭvā lokāḥ pravyathitās tathāham}
...
\par
\begin{verse}
\textit{daṁṣṭrā-karālāni ca te mukhāni} \\
\textit{dṛṣṭvaiva kālānala-sannibhāni} \\
\textit{diśo na jāne na labhe ca śarma} \\
\textit{prasīda deveśa jagan-nivāsa}
...
\par
\begin{verse}
\textit{amī ca tvāṁ dhṛtarāṣṭrasya putrāḥ} \\
\textit{sarve sahaivāvani-pāla-saṅghaiḥ} \\
\textit{bhīṣmo droṇaḥ sūta-putras tathāsau} \\
\textit{sahāsmadīyair api yodha-mukhyaiḥ} \\
\textit{vaktrāṇi te tvaramāṇā viśanti} \\
\textit{daṁṣṭrā-karālāni bhayānakāni} \\
\textit{kecid vilagnā daśanāntareṣu} \\
\textit{sandṛśyante cūrṇitair uttamāṅgaiḥ}
...
\par
\begin{verse}
\textit{yathā nadīnāṁ bahavo ’mbu-vegāḥ} \\
\textit{samudram evābhimukhā dravanti} \\
\textit{tathā tavāmī nara-loka-vīrā} \\
\textit{viśanti vaktrāṇy abhivijvalanti}
...
\par
\begin{verse}
\textit{yathā pradīptaṁ jvalanaṁ pataṅgā} \\
\textit{viśanti nāśāya samṛddha-vegāḥ} \\
\textit{tathaiva nāśāya viśanti lokās} \\
\textit{tavāpi vaktrāṇi samṛddha-vegāḥ}
...
\par
\begin{verse}
\textit{lelihyase grasamānaḥ samantāl} \\
\textit{lokān samagrān vadanair jvaladbhiḥ} \\
\textit{tejobhir āpūrya jagat samagraṁ} \\
\textit{bhāsas tavogrāḥ pratapanti viṣṇo}
...
\par
\begin{verse}
\textit{ākhyāhi me ko bhavān ugra-rūpo} \\
\textit{namo ’stu te deva-vara prasīda} \\
\textit{vijñātum icchāmi bhavantam ādyaṁ} \\
\textit{na hi prajānāmi tava pravṛttim}
...
\begin{verse}
\textit{śrī-bhagavān uvāca} \\
\textit{kālo ’smi loka-kṣaya-kṛt pravṛddho} \\
\textit{lokān samāhartum iha pravṛttaḥ} \\
\textit{ṛte ’pi tvāṁ na bhaviṣyanti sarve} \\
\textit{ye ’vasthitāḥ praty-anīkeṣu yodhāḥ}
...
\begin{verse}
\textit{sañjaya uvāca} \\
\textit{etac chrutvā vacanaṁ keśavasya} \\
\textit{kṛtāñjalir vepamānaḥ kirīṭī} \\
\textit{namaskṛtvā bhūya evāha kṛṣṇaṁ} \\
\textit{sa-gadgadaṁ bhīta-bhītaḥ praṇamya}
...
\begin{verse}
\textit{arjuna uvāca} \\
\textit{sthāne hṛṣīkeśa tava prakīrtyā} \\
\textit{jagat prahṛṣyaty anurajyate ca} \\
\textit{rakṣāṁsi bhītāni diśo dravanti} \\
\textit{sarve namasyanti ca siddha-saṅghāḥ}
...
\par
\begin{verse}
\textit{kasmāc ca te na nameran mahātman} \\
\textit{garīyase brahmaṇo ’py ādi-kartre} \\
\textit{ananta deveśa jagan-nivāsa tvam} \\
\textit{akṣaraṁ sad-asat tat paraṁ yat}
...
\par
\begin{verse}
\textit{tvam ādi-devaḥ puruṣaḥ purāṇas} \\
\textit{tvam asya viśvasya paraṁ nidhānam} \\
\textit{vettāsi vedyaṁ ca paraṁ ca dhāma} \\
\textit{tvayā tataṁ viśvam ananta-rūpa}
...
\par
\begin{verse}
\textit{vāyur yamo ’gnir varuṇaḥ śaśāṅkaḥ} \\
\textit{prajāpatis tvaṁ prapitāmahaś ca} \\
\textit{namo namas te ’stu sahasra-kṛtvaḥ} \\
\textit{punaś ca bhūyo ’pi namo namas te}
...
\par
\begin{verse}
\textit{namaḥ purastād atha pṛṣṭhatas te} \\
\textit{namo ’stu te sarvata eva sarva} \\
\textit{ananta-vīryāmita-vikramas tvaṁ} \\
\textit{sarvaṁ samāpnoṣi tato ’si sarvaḥ}
...
\par
\begin{verse}
\textit{sakheti matvā prasabhaṁ yad uktaṁ} \\
\textit{he kṛṣṇa he yādava he sakheti} \\
\textit{ajānatā mahimānaṁ tavedaṁ} \\
\textit{mayā pramādāt praṇayena vāpi} \\
\textit{yac cāvahāsārtham asat-kṛto ’si} \\
\textit{vihāra-śayyāsana-bhojaneṣu} \\
\textit{eko ’tha vāpy acyuta tat-samakṣaṁ} \\
\textit{tat kṣāmaye tvām aham aprameyam}

\noindent Considering You as my dear friend and being unaware of Your majesty, whatever was rashly spoken by me out of delusion or affection, such as \enquote{O Kṛṣṇa, O Yādava,\footnote{Kṛṣṇa is a descendant of King Yadu, and is therefore also referred to as Yādava.} O friend} and whenever You were jokingly shown disrespect while playing, resting, while sitting or eating together, whether alone or in the presence of others, O Acyuta---for all that, I beg Your forgiveness, O incomprehensible One. (11.41–42)
\end{verse}
\par
...
\noindent You are the father of this world, of both the moving and the unmoving beings. You are the most worshipable and the greatest teacher. There is no one equal to You; how could there be someone greater in even all the three worlds, O incomparable power? (11.43)
\end{verse}
\par
...
\par
\begin{verse}
\textit{tasmāt praṇamya praṇidhāya kāyaṁ} \\
\textit{prasādaye tvām aham īśam īḍyam} \\
\textit{piteva putrasya sakheva sakhyuḥ} \\
\textit{priyaḥ priyāyārhasi deva soḍhum}
...
\par
\begin{verse}
\textit{adṛṣṭa-pūrvaṁ hṛṣito ’smi dṛṣṭvā} \\
\textit{bhayena ca pravyathitaṁ mano me} \\
\textit{tad eva me darśaya deva rūpaṁ} \\
\textit{prasīda deveśa jagan-nivāsa}
...
\par
\begin{verse}
\textit{kirīṭinaṁ gadinaṁ cakra-hastam} \\
\textit{icchāmi tvāṁ draṣṭum ahaṁ tathaiva} \\
\textit{tenaiva rūpeṇa catur-bhujena} \\
\textit{sahasra-bāho bhava viśva-mūrte}
...
\par
\begin{verse}
\textit{na veda-yajñādhyayanair na dānair} \\
\textit{na ca kriyābhir na tapobhir ugraiḥ} \\
\textit{evaṁ-rūpaḥ śakya ahaṁ nṛ-loke} \\
\textit{draṣṭuṁ tvad anyena kuru-pravīra}
...
\begin{verse}
\textit{sañjaya uvāca} \\
\textit{ity arjunaṁ vāsudevas tathoktvā} \\
\textit{svakaṁ rūpaṁ darśayām āsa bhūyaḥ} \\
\textit{āśvāsayām āsa ca bhītam enaṁ} \\
\textit{bhūtvā punaḥ saumya-vapur mahātmā}
...
\enquote{When this Viśvarūpa disappeared, in front of him stood the \textit{Caturbhuja}---the four-armed Mahā-Viṣṇu with the \textit{Cakra}, the \textit{Śaṅkha}, the \textit{Gadā}, and the \textit{Padma}. And this form is so sweet and calm that the whole atmosphere completely changed. Even the \textit{bhāva} of Arjuna inside himself; he is not trembling, he is not shaking, he is calm, he is at ease, and he can understand. His mind has automatically subdued itself.}
...
\noindent But if you are incapable of practice, be devoted to My \textit{sevā}. Also by performing actions for My sake, you shall attain perfection. (12.10)
\end{verse}
\par
...
\noindent But if you are incapable of doing even that, then resort to \textit{karma-yoga}, give up the fruit of all action, and act with a controlled mind. (12.11)
\end{verse}
\par
...
\enquote{Bhagavān Kṛṣṇa praises His devotees, praises those who are surrendered to Him, showing how dear He is surrendered to them. You think that you are longing for Him? No, He is longing more for you. You think that you love Him? Your love is like a grain of dust, but His Love is like an ocean. You think that you are walking toward Him? He is running toward you. That’s the greatness and the humility of the Lord Himself.} \chapter{Chapter 13: \\Kṣetra-kṣetrajña-vibhāga-yoga}\label{chap-ksetra-ksetrajna-vibhaga-yoga}

\paragraph*{\MakeUppercase{The Distinction of Matter and Spirit}}
...
\par
\begin{verse}
\textit{ṛṣibhir bahudhā gītaṁ chandobhir vividhaiḥ pṛthak} \\
\textit{brahma-sūtra-padaiś caiva hetumadbhir viniścitaiḥ}

\noindent This knowledge has been sung about differently by various sages in multiple ways through hymns and also through conclusive arguments of the \textit{Brahma-sūtra}.\footnote{A philosophical scripture that summarizes the spiritual ideas of the \textit{Upaniṣads}.} (13.5)
\end{verse}
\par
...
\par
\begin{verse}
\textit{mahā-bhūtāny ahaṅkāro buddhir avyaktam eva ca} \\
\textit{indriyāṇi daśaikaṁ ca pañca cendriya-gocarāḥ} \\
\textit{icchā dveṣaḥ sukhaṁ duḥkhaṁ saṅghātaś cetanā dhṛtiḥ} \\
\textit{etat kṣetraṁ samāsena sa-vikāram udāhṛtam}

\noindent The five principal elements, the ego, the intellect, the primordial material substance,\footnote{The unmanifest state of \textit{prakṛti} not yet differentiated into the various forms of material nature.} the ten senses,\footnote{The \textit{jñānendriyas}, which are the five modes of perception (sight, hearing, touch, taste, smell), and the \textit{karmendriyas}, which are the five organs of action (hands, feet, voice, anus, and genitals).} the mind, the five objects of the senses,\footnote{Form/color, sound, touch sensations, flavor, and aroma} desire, aversion, pleasure and pain, the body itself, consciousness, and one’s resolve---in brief this is described as the field along with its modifications. (13.6–7)
\end{verse}
\par


\enquote{Here Bhagavān is saying, \enquote{My dear Arjuna, I know you have been confused with My cosmic form. You have heard Me talking about so many things. I know you are confused, but at the same time you want to know. I will reveal to you in a very simple way, in an easy way, the truth about the purpose of having a human body, the greatness of a human body, and why you have received this human body. I will reveal to you the true identity of the Supersoul, which is unlimited, birthless, eternal, whereas this body and everything which is created is the opposite. The body itself goes through constant changes. At all times you are getting old and at all times this body is moving toward its end.}}
...
\section{Verses 8-12: Kṛṣṇa Describes True Knowledge}\label{sec-verses-8-12-krishna-describes-true-knowledge}
...
\noindent Those established in \textit{sattva} rise upward; those in \textit{rajas} remain in the middle; and those in \textit{tamas}, whose character is established in the vilest qualities, go downward. (14.18)
\end{verse}
\par
...
\enquote{Bhagavān Kṛṣṇa says, \enquote{I am this eternal God Himself who is formless and pervades over this whole universe. I am the One who sustains; I am the One who creates; I am the One who destroys. I am the Supreme, unmanifest and formless God. I am Śiva. I am Viṣṇu. I am Rāma. I am Kṛṣṇa. I am Jesus. I am Allah. I am Yahweh. I am all these Names. Here I am in front of you as Vāsudeva Kṛṣṇa.} All these forms and aspects of the Divine have been manifested throughout time to remind people of their real \textit{dharma}; of why they have come here; why they are here; of how to free themselves; of how to attain their cosmic body and how to rise above this duality; how to rise above the game of \textit{māyā} and how to rise above these three \textit{guṇas}. And only through this will one attain supreme bliss, will one attain this blissful state, will one become blissful. Kṛṣṇa Himself says here, \enquote{It’s easy to attain this state. Just surrender to Me! If you love Me, if you serve Me, if you hear My glory, I shall reveal this supreme bliss to you. Not outside, but within yourself and from within yourself you will beam this out to all.} This is God-realization. This is surrender and this is true happiness.}
 \chapter{Chapter 15: \\Puruṣottama-yoga}\label{chap-purusottama-yoga}

\paragraph*{\MakeUppercase{Knowing the Supreme Person}}
...
Having described the soul’s position, Kṛṣṇa explains how He as the Lord sustains creation in various ways. He is the energy of the Moon, the fire that digests food. He is the one who resides in the hearts of all beings and is the knower of the \textit{Vedas}.
...
\begin{verse}
\textit{śrī-bhagavān uvāca} \\
\textit{ūrdhva-mūlam adhaḥ-śākham} \\
\textit{aśvatthaṁ prāhur avyayam} \\
\textit{chandāṁsi yasya parṇāni} \\
\textit{yas taṁ veda sa veda-vit}
...
\par
\begin{verse}
\textit{adhaś cordhvaṁ prasṛtās tasya} \\
\textit{śākhā guṇa-pravṛddhā viṣaya-pravālāḥ} \\
\textit{adhaś ca mūlāny anusantatāni} \\
\textit{karmānubandhīni manuṣya-loke}
...
\par
\begin{verse}
\textit{na rūpam asyeha tathopalabhyate} \\
\textit{nānto na cādir na ca sampratiṣṭhā} \\
\textit{aśvattham enaṁ suvirūḍha-mūlam} \\
\textit{asaṅga-śastreṇa dṛḍhena chittvā} \\
\textit{tataḥ padaṁ tat parimārgitavyaṁ} \\
\textit{yasmin gatā na nivartanti bhūyaḥ} \\
\textit{tam eva cādyaṁ puruṣaṁ prapadye} \\
\textit{yataḥ pravṛttiḥ prasṛtā purāṇī}
...
\enquote{Through dispassion one advances toward God-realization. These qualities that awaken, that one attains, through devotion and surrender, cause one not to return into this world. Who else can give this supreme blissful state to you? Can another human being give this to you? No, they can’t!}
...
\par
\begin{verse}
\textit{nirmāna-mohā jita-saṅga-doṣā} \\
\textit{adhyātma-nityā vinivṛtta-kāmāḥ} \\
\textit{dvandvair vimuktāḥ sukha-duḥkha-saṁjñair} \\
\textit{gacchanty amūḍhāḥ padam avyayaṁ tat}
...
\par
\begin{verse}
\textit{sarvasya cāhaṁ hṛdi sanniviṣṭo} \\
\textit{mattaḥ smṛtir jñānam apohanaṁ ca} \\
\textit{vedaiś ca sarvair aham eva vedyo} \\
\textit{vedānta-kṛd veda-vid eva cāham}
...
\noindent One who is not deluded and thus understands Me as the Supreme Puruṣa is all-knowing and worships Me with the entirety of their being, O descendant of Bharata. (15.19)
\end{verse}
\par
...
\enquote{They [righteous persons] don’t let themselves be filled with other things of this world. They drink the nectar of the \textit{Vedas} and meditate upon the essence of the \textit{Vedas}. They do everything to realize the Lord. Studying the \textit{Vedas} is also about chanting, about reciting different hymns in the praise of the Lord, and about reflection upon them; not just about chant and finish, but about going into the deepness of it.}
...
\enquote{Taking the shelter of the master, following the scriptures, following what the master says, should be done in a selfless spirit, with a humble heart. This must be done with a heart full of Love. And that’s what will bring the grace upon oneself. It is through this that one attains God-realization.}
 \chapter{Chapter 17: \\Śraddhā-traya-vibhāga-yoga}\label{chap-sraddha-traya-vibhaga-yoga}

\paragraph*{\MakeUppercase{The Three Divisions of Faith}}
...
\enquote{\textit{Bhaktas} with \textit{sattvic} qualities turn their minds toward godly things, toward the Divine, toward enlightenment, toward awakening. They worship the Lord with faith, with love and dedication. All they do is for the Lord, nothing is for their self-interest or gain.}
...
\enquote{When one does something in a calm state and with a calm mind, it bears positiveness. But, if somebody does something in a restless way, in an agitated way, it always goes wrong. You see it in your life itself. When you take a decision very quickly, without even considering it, you always take the wrong decision. Even if the right decision was so clear in front of you, you blind yourself. The mind becomes blind so that you don’t even perceive. You can’t make the distinction between what is right and what is wrong. Then you always tend to take the wrong decision and afterward you say, \enquote{Oh I knew it! I should have listened to the first intuitive feeling that arose.} But that’s how you have to learn to listen to your intuition. When the mind is calm and gentle, when the mind is silenced through meditation, when you are absorbed in that, you learn to control it and then you also learn to take the right decision. So, the mind is tamed. It’s not running very quickly.}
...
\par
\begin{verse}
\textit{oṁ tat sad iti nirdeśo brahmaṇas tri-vidhaḥ smṛtaḥ} \\
\textit{brāhmaṇās tena vedāś ca yajñāś ca vihitāḥ purā}

\noindent \enquote{\textit{Oṁ} \textit{tat} \textit{sat}}---this is considered the threefold indication of Brahman by which the \textit{brāhmaṇas}, the \textit{Vedas}, and \textit{yajñas} were established in former times. (17.23)
\end{verse}
\par
...
\par
\begin{verse}
\textit{tad ity anabhisandhāya phalaṁ yajña-tapaḥ-kriyāḥ} \\
\textit{dāna-kriyāś ca vividhāḥ kriyante mokṣa-kāṅkṣibhiḥ}

\noindent Without expecting the fruit of their action, the seekers of liberation chant \enquote{\textit{tat}} when performing various acts of sacrifice, austerity, and charity. (17.25)
\end{verse}
\par
...
\par
\begin{verse}
\textit{sad-bhāve sādhu-bhāve ca sad ity etat prayujyate} \\
\textit{praśaste karmaṇi tathā sac-chabdaḥ pārtha yujyate}

\noindent The term \enquote{\textit{sat}} is used in the sense of \enquote{existence} and \enquote{virtue.} It is also used for an auspicious action, O Pārtha. (17.26)
\end{verse}
\par
...
\par
\begin{verse}
\textit{yajñe tapasi dāne ca sthitiḥ sad iti cocyate} \\
\textit{karma caiva tad-arthīyaṁ sad ity evābhidhīyate}

\noindent Perseverance in sacrifice, austerity, and charity is called \enquote{\textit{sat}}; and any action performed for the sake of these is also termed \enquote{\textit{sat}.} (17.27)
\end{verse}
\par
...
\enquote{Everything comes from \textit{oṁ} and everything will go back into \textit{oṁ}. There is nothing else. That’s why the \textit{brāhmaṇas}, the great sages start all the \textit{mantras} with \textit{oṁ}. When compiling all the \textit{mantras}, Vedavyāsa put \textit{oṁ} at the beginning of all \textit{mantras}. He said, \enquote{The benefit of \textit{oṁ} is that it’s a reminder of God.} That’s why when we start with \textit{oṁ}, it reminds us that it is \textit{sattvic} in itself. It is directed toward the Divine. It’s not in vain. It’s not for self-gratification, but it’s for pleasing the Lord. It is Him.}
...
\par
\begin{verse}
\textit{aśraddhayā hutaṁ dattaṁ tapas taptaṁ kṛtaṁ ca yat} \\
\textit{asad ity ucyate pārtha na ca tat pretya no iha}

\noindent O Pārtha, whatever is offered as sacrifice, given in charity, practiced as austerity, and whatever else is carried out---if it is devoid of faith, it is called \enquote{\textit{asat}.} It is worthless in this world and the next. (17.28)
\end{verse}
\par


\enquote{If one is performing any action without faith, it’s of no use doing it. Because that action which is performed without faith is a forbidden act. This action will ruin oneself, this action brings sinful qualities to one and the fruit of it is also very destructive. People doing such actions without faith, doing all the service, all the charities, performing all the prayers, practicing all the \textit{sādhana} in a hypocritical way, here Bhagavān says that it’s called \textit{asat}. As this \textit{asat} is just a show, people have to bear the fruit, people have to reap the painful consequences of their acts.}

\enquote{Whatever one does, one has to bear the fruit. If you have planted a seed which is not good, it will grow, but don’t expect the tree to bear sweet fruits, even if you water it with sweet water. It will bear fruits according to the seed that you planted. If you plant a good seed, it shall grow and multiply a thousand-fold. When one does a sinful act, or act with a selfish motive, even if it appears very nice on the outside, one will bear the consequence of that. It all depends on how much faith people have. If they have faith in what they are doing, it’s good, they will also bear those kinds of things in their life. If they have faith in the Lord and completely surrender to the Lord, their faith will also grow and bring them toward the Lord, and their faith will also bring the Lord to them.}

 \chapter{Chapter 18: \\Mokṣa-sannyāsa-yoga}\label{chap-moksa-sannyasa-yoga}
...
\enquote{A \enquote{\textit{tyāgī}} is somebody who works in the outside world, yet is not attached to the fruit of their action. Whatever they do, their mind is so focused on the Lord, they are so absorbed in the \textit{sāttvic bhāva} inside of them, that they don’t get drawn into any external objectives or aims in life, apart from serving the Lord. They do their \textit{karma-yoga}, with their determination fixed only on serving. They have \textit{bhakti}, devotion.}
...
\noindent O Arjuna, when any prescribed action is performed as a matter of duty, giving up attachment to it as well as its fruit, such renunciation is considered to be \textit{sattvic}. (18.9)
\end{verse}
\par
...
\textit{hatvāpi sa imāṁl lokān na hanti na nibadhyate}
...
\noindent Knowledge, action, and the performer of action are threefold, according to the division of \textit{guṇas}. Now hear about them properly as described in Sāṅkhya. (18.19)
\end{verse}
\par
...
\textit{atattvārthavad alpaṁ ca tat tāmasam udāhṛtam}
...
\enquote{The mind runs always toward the outside as a result of expectation, of desire: \enquote{I want a car,} \enquote{I want a wife,} \enquote{I want a husband.} \enquote{I want money,} \enquote{I want this,} \enquote{I want that.} When you first get these things, it’s great fun; you feel great joy, happiness. How long do these feelings last? Not for too long. Only until the sense organs meet with the sense object; only for the short-term. And when these feelings subside, the mind jumps to something else. Due to this attachment to sense objects, if one fails to get something the mind desires, one goes into deep depression, one becomes aggressive, and one becomes deluded.}
...
\noindent Using the purified intellect; subduing the mind with determination; giving up the objects of the senses such as sound and casting aside attraction and hatred; living in solitude; eating little; restraining one's speech, body, and mind; constantly engaged in the \textit{yoga} of meditation and taking full shelter of dispassion; giving up ego, power, arrogance, desire, anger, and possessiveness, peaceful and free from the sense of ownership, one becomes fit for the state of Brahman. (18.51–53)
\end{verse}
\par


\enquote{Those whose minds and intellects no longer entertain attraction toward the outside, whose minds are not longing and running toward sense pleasures, needs, wants; whose thirst for outside enjoyment has ceased; for them, there is cessation of \textit{karma}. Their minds are subdued, controlled, free from all kinds of desires. Here Bhagavān says that such a mind, with such surrender, true discipline, and fully absorbed into \textit{sādhana}, fully absorbed into Love, is free from the bondage of \textit{karma}. The ones whose minds are fully absorbed in the Divine attain God consciousness. They attain the consciousness of the Lord and they start to reflect divine qualities, the divine light.}
...
\enquote{Bhagavān is saying here that this is the highest form of \textit{bhakti}, \textit{parā-bhakti}. When one is fully immersed in the Lord, Bhagavān reveals Himself in one’s own heart, and then one attains one’s spiritual body and attains the Lord Himself.}
...
\enquote{Here Bhagavān gives Arjuna assurance, because Arjuna was taken aback. The Lord gives this assurance not only to Arjuna, but to whoever is surrendered to Him: to those whose minds are continuously focused on Him; who through their \textit{sādhana}, when they sit in meditation, are fully absorbed in Him and see Him only; who are devoted; who do all their \textit{sādhana} in a state of serving Him, loving Him; who do their spiritual practices; who worship Him; who bow down in front of Him due to the humility in their hearts. Bhagavān says, \enquote{You shall come to Me alone.} There’s no other way. If you are surrendered to Him, you will achieve Him. Because if you surrender to Him fully, He will also surrender Himself fully to you. And if He surrenders fully to you, if your heart is filled with delight with the Lord, you will attain Him. He was saying, \enquote{Your job is to focus your mind, devote yourself, worship, bow down. If you do your job, I Myself will give Myself.}}

\enquote{Bhagavān reminds Arjuna of His Love for him. And this is unique. He says, \enquote{Arjuna, you are Mine, and I’m yours.} Bhagavān says there is no difference, \enquote{What belongs to Me, belongs to you. You are dear to Me. You have faith in Me. You have trust in Me. You are devoted to Me. You worship Me.} Here Bhagavān is also saying, \enquote{Count on Me fully. Don’t count on your own effort; don’t count on your own strength, your own will.} Somebody with pride, with ignorance, will count very much on their own effort. Here Bhagavān says that with your own effort you will reach somewhere, but if you want to reach the supreme state of surrender, if you want to achieve the goal of life, only when you surrender completely and fully to the Lord Himself will you reach this.}
...
tendency toward pleasure and expression
...
As you evolve on the path, ever-increasing experiences of true unconditional Love and lasting happiness become more commonplace, regardless of the circumstances. Most often, this leads to a heartfelt yearning to connect more deeply with God, and Paramahamsa Vishwananda’s unconditional Love, support, and guidance are available to everyone who wants to grow and evolve on this path to God-realization.
...
\noindent Discover more at \textbf{bhaktimarga.org} \chapter*{Glossary}
...
The Mantra of the Hari Bhakta Sampradāya\\[1em]
