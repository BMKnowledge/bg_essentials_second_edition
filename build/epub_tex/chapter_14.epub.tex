...
\noindent Bhagavān Kṛṣṇa said: I shall once again speak about the best and highest wisdom among all forms of knowledge, having realized which, all sages have attained the supreme perfection beyond this world.
\end{verse}
\par



\par\noindent\textbf{14.2}\par
\begin{verse}
\textit{idaṁ jñānam upāśritya mama sādharmyam āgatāḥ} \\
\textit{sarge ’pi nopajāyante pralaye na vyathanti ca}

\noindent Taking refuge in this wisdom, they attain the same nature as Me. As a result, they are not born at the time of creation and remain undisturbed even at the time of dissolution.
\end{verse}
\par



\par\noindent\textbf{14.3}\par
\begin{verse}
\textit{mama yonir mahad brahma tasmin garbhaṁ dadhāmy aham} \\
\textit{sambhavaḥ sarva-bhūtānāṁ tato bhavati bhārata}

\noindent My womb is the totality of material existence in which I place the seed from which arises the origin of all beings, O descendant of Bharata.
\end{verse}
\par
...
\noindent O Kaunteya, whatever forms are created in various wombs, material nature is their womb and I am the seed-giving father.
\end{verse}
\par
...
\par\noindent\textbf{14.5}\par
\begin{verse}
\textit{sattvaṁ rajas tama iti guṇāḥ prakṛti-sambhavāḥ} \\
\textit{nibadhnanti mahā-bāho dehe dehinam avyayam}

\noindent \textit{Sattva}, \textit{rajas}, and \textit{tamas}---these \textit{guṇas} arise from \textit{prakṛti} and bind the immutable embodied Self dwelling in the body, O mighty-armed Arjuna.
\end{verse}
\par



\par\noindent\textbf{14.6}\par
\begin{verse}
\textit{tatra sattvaṁ nirmalatvāt prakāśakam anāmayam} \\
\textit{sukha-saṅgena badhnāti jñāna-saṅgena cānagha}

\noindent Of these, \textit{sattva} is illuminating since it is pure and free from contamination. O sinless one, it binds through attachment to happiness and knowledge.
\end{verse}
\par



\par\noindent\textbf{14.7}\par
\begin{verse}
\textit{rajo rāgātmakaṁ viddhi tṛṣṇā-saṅga-samudbhavam} \\
\textit{tan nibadhnāti kaunteya karma-saṅgena dehinam}

\noindent Know that \textit{rajas} has the nature of passion and is the origin of intense craving and attachment. It binds the embodied Self through attachment to action, O Kaunteya.
\end{verse}
\par



\par\noindent\textbf{14.8}\par
\begin{verse}
\textit{tamas tv ajñāna-jaṁ viddhi mohanaṁ sarva-dehinām} \\
\textit{pramādālasya-nidrābhis tan nibadhnāti bhārata}

\noindent Know that \textit{tamas} gives rise to ignorance and deludes all embodied beings. It binds through negligence, laziness, and sleep, O descendant of Bharata.
\end{verse}
\par



\par\noindent\textbf{14.9}\par
\begin{verse}
\textit{sattvaṁ sukhe sañjayati rajaḥ karmaṇi bhārata} \\
\textit{jñānam āvṛtya tu tamaḥ pramāde sañjayaty uta}

\noindent \textit{Sattva} binds one to happiness, and \textit{rajas} to action, O descendant of Bharata. But \textit{tamas}, obscuring knowledge, binds to negligence.
\end{verse}
\par
...
\noindent O descendant of Bharata! Overpowering \textit{rajas} and \textit{tamas}, \textit{sattva} prevails, subduing \textit{sattva} and \textit{tamas}, \textit{rajas} prevails, and likewise, subduing \textit{sattva} and \textit{rajas}, \textit{tamas} prevails
\end{verse}
\par
...
\noindent When illuminating wisdom arises in all the sense organs of this body, then one should know that \textit{sattva} is predominant.
\end{verse}
\par
...
\noindent Greed, intense activity, initiation of various different tasks, restlessness, and craving---these arise when \textit{rajas} is dominant, O best of the Bharatas.
\end{verse}
\par
...
\noindent Darkness, inertia, negligence, and delusion---these arise when \textit{tamas} dominates, O descendant of Kuru.
\end{verse}
\par
...
\noindent If the embodied Self meets death while \textit{sattva} predominates, then it attains the pure realms of those who know the Supreme.
\end{verse}
\par
...
\noindent Meeting death when \textit{rajas} predominates, one is born among those attached to action. Similarly, one who dies when \textit{tamas} prevails is born among beings in delusion.
\end{verse}
\par
...
\noindent The result of virtuous action is said to be \textit{sattvic} and pure, but the result of \textit{rajasic} action is suffering, and the result of \textit{tamasic} action is ignorance.
\end{verse}
\par
...
\noindent From \textit{sattva} arises knowledge, from \textit{rajas} comes greed, and from \textit{tamas} arise negligence, delusion, and ignorance.
\end{verse}
\par
...
\noindent Those established in \textit{sattva} rise upwards; those in \textit{rajas} remain in the middle; and those in \textit{tamas}, whose character is established in the vilest qualities, go downwards.
\end{verse}
\par
...
\par\noindent\textbf{14.19}\par
\begin{verse}
\textit{nānyaṁ guṇebhyaḥ kartāraṁ yadā draṣṭānupaśyati} \\
\textit{guṇebhyaś ca paraṁ vetti mad-bhāvaṁ so ’dhigacchati}

\noindent When the seer perceives that there is no doer other than the \textit{guṇas}, and knows itself to be superior to the \textit{guṇas}, it attains My divine nature.
\end{verse}
\par



\par\noindent\textbf{14.20}\par
\begin{verse}
\textit{guṇān etān atītya trīn dehī deha-samudbhavān} \\
\textit{janma-mṛtyu-jarā-duḥkhair vimukto ’mṛtam aśnute}

\noindent Transcending these three \textit{guṇas} that give rise to the body, the embodied Self is liberated from birth, death, old age, and suffering, and attains immortality.
\end{verse}
\par
...
\par\noindent\textbf{14.21}\par
\begin{verse}
\textit{arjuna uvāca} \\
\textit{kair liṅgais trīn guṇān etān atīto bhavati prabho} \\
\textit{kim-ācāraḥ kathaṁ caitāṁs trīn guṇān ativartate}

\noindent Arjuna said: By what signs is he characterized as one who has gone beyond the three \textit{guṇas}? How does such a person behave? And how does one overcome the three \textit{guṇas}, O Lord?
\end{verse}
\par



\par\noindent\textbf{14.22–25}\par
\begin{verse}
\textit{śrī-bhagavān uvāca} \\
...
\par\noindent\textbf{14.26}\par
\begin{verse}
\textit{māṁ ca yo ’vyabhicāreṇa bhakti-yogena sevate} \\
\textit{sa guṇān samatītyaitān brahma-bhūyāya kalpate}

\noindent But one who serves Me with unwavering devotion transcends the \textit{guṇas} and becomes fit to realize Brahman.\footnote{Used here to refer to the impersonal conception of the supreme reality. Its abstract features (immortal, unchanging, eternal, blissful, etc.) have a concrete existence in the Supreme Lord.}
\end{verse}
\par



\par\noindent\textbf{14.27}\par
\begin{verse}
\textit{brahmaṇo hi pratiṣṭhāham amṛtasyāvyayasya ca} \\
\textit{śāśvatasya ca dharmasya sukhasyaikāntikasya ca}

\noindent I am indeed the foundation of the immortal and unchanging Brahman, as well as the basis of the eternal \textit{dharma} and absolute happiness.
\end{verse}
\par
