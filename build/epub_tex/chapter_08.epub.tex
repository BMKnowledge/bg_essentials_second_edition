...
\noindent Arjuna said: What is that Brahman? What is \textit{adhyātma}? What is meant by \textit{karma}? What is meant by \textit{adhibhūta}? And what is said to be \textit{adhidaiva}, O best of men?
\end{verse}
\par
...
\noindent Bhagavān Kṛṣṇa said: Brahman is the Supreme Imperishable, \textit{adhyātma} is said to be that which possesses individual existence, and the cosmic emanation which gives rise to material beings is known as \textit{karma}.
\end{verse}
\par
